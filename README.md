...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/get_version-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7929&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/get_version-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `get_version` can be installed with:

```
conda install get_version
```

It is possible to list all of the versions of `get_version` available on your platform with:
